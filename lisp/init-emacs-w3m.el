...
(setq w3m-search-engine-alist
      '(("g" "http://www.google.co.uk/search?q=%s" utf-8)
        ...
        ;; elisp code search
        ("s" "http://www.google.de/search?q=%s+filetype:el"  utf-8)
        ;; wikipedia
...
(defun w3mext-hacker-search ()
  ...
  (let ((keyword (w3m-guess-keyword)))
    ;; google
    (browse-url-generic (concat "http://www.google.de/search?hl=en&q=%22"
                                keyword
                                "%22"
                                (if buffer-file-name
									...
									"")))
    ;; stackoverflow.com
    (browse-url-generic (concat "http://www.google.de/search?hl=en&q="
                                keyword
...
(defun w3m-yt-view ()
  ...
  (let ((url (or (w3m-anchor) (w3m-image))))
    (message url)
    (start-process "YouTube" nil "mpv" url)))
