  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (bold (:weight bold))
      (bold-italic (:weight bold))
      (underline (:underline t))
      (italic ())
      (font-lock-builtin-face (:foreground ,violet))
      (font-lock-comment-delimiter-face (:foreground ,faintest ))
      (font-lock-comment-face (:foreground ,faintest ))
      ...
      (erb-comment-face (:background ,alt-background :weight bold ))
